...
import 'package:fawri_app_refactor/core/widgets/widgets_item_view/widget_drop_down.dart';
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          AnimatedOpacity(
            opacity: ((widget.item?.variants?[0].size.toString() ==
                    "${widget.item!.id}"))
                ? 0
            ...
            child: Row(
              ...
              children: [
                ...
                Visibility(
                  visible: (productItemController.basicQuantityItems[
                              widget.item?.id.toString().trim()] ==
                          null)
                      ? false
                      : (int.tryParse(productItemController.basicQuantityItems[
                                          widget.item?.id.toString().trim()]
                                      ?.toString() ??
                                  '') ==
                              1)
                ...
                (productItemController.basicQuantityItems[
                            widget.item?.id.toString().trim()] !=
                        null)
                    ? (int.tryParse(productItemController.basicQuantityItems[
                                        widget.item?.id.toString().trim()]
