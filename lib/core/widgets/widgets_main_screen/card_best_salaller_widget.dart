...
import 'package:fawri_app_refactor/core/widgets/custom_image.dart';
          ...
          children: [
            Expanded(
              ...
              child: CustomImageSponsored(
                imageUrl: pageMainScreenController
                        .bestSellersProducts[widget.index].vendorImagesLinks?[0]
                        .toString() ??
                    "",
                boxFit: BoxFit.cover,
                padding: EdgeInsets.zero,
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        ...
                        pageMainScreenController
                            .bestSellersProducts[widget.index].title
                            .toString(),
                    ...
                    Flexible(
                      child: Text(
                        ...
                        pageMainScreenController
                            .bestSellersProducts[widget.index].newPrice
                            .toString(),
                        textDirection: TextDirection.rtl,
                        textAlign: TextAlign.center,
                        style: CustomTextStyle().heading1L.copyWith(
