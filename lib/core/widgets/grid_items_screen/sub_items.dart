  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      SubMainCategoriesController subMainCategoriesController =
          context.read<SubMainCategoriesController>();
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: (subMainCategoriesController.subCategories.isEmpty ||
                        ...
                        onTap: () async {
                          await analyticsService.logEvent(
                            ...
                            parameters: {
                              ...
                              "product_id": subMainCategoriesController
                                      .subCategories[index].id
                                      ?.toString() ??
                                  "",
                              "product_title": subMainCategoriesController
