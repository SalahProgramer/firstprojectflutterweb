...
import 'package:fawri_app_refactor/core/services/sentry/sentry_service.dart';
        ...
        return PopScope(
          ...
          child: AlertDialog(
            content: Column(
              ...
              children: [
                LottieWidget(
                  name: Assets.lottie.updateLottie,
                ),
                SizedBox(
                  height: 10.h,
                ),
                Text(" تأكيد تحديث بياناتك",
                    style: CustomTextStyle()
                        .heading1L
                        .copyWith(color: Colors.black, fontSize: 15.sp)),
                Text("هل أنت متأكد من تحديث الإسم و الرقم؟",
                    style: CustomTextStyle()
                        .heading1L
                ...
                children: [
                      ...
                      onPressed: () async {
                        try {
                          ...
                          final f2 = pointsControllerClass.getPointsFromAPI(
                              phone: phone);
                          final f3 =
                              orderController.initialsOrders(phone: phone);
                  ...
                  CustomButtonWithIconWithoutBackground(
                    ...
                    textStyle: CustomTextStyle()
                        .rubik
                        .copyWith(color: Colors.grey[600], fontSize: 12.sp),
                    onPressed: () {
                      NavigatorApp.pop();
                    },
                    textIcon: '',
