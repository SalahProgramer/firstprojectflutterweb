...
import 'package:fawri_app_refactor/controllers/free_gift_controller.dart';
  ...
  return showDialog(
    ...
    builder: (context) {
      ...
      FreeGiftController freeGiftController =
          context.watch<FreeGiftController>();
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ButtonDone(
                              text: (freeGiftController
                                          .theItemFree.variants?[0].size ==
                                      "")
                                  ? "لم يعد متوفر"
                                  : (productItemController.inCart[
                              ...
                              onPressed: () async {
                                ...
                                await cartController.insertData(
                                    id:
                                        "${freeGiftController.theItemFree.id}000",
                                    variantId: freeGiftController.theItemFree.variants?[0].id,
                                    productId:
                                        freeGiftController.theItemFree.id,
                                    shopId: freeGiftController.theItemFree.shopId
                                        .toString(),
                                    employee: freeGiftController
                                        .theItemFree.variants?[0].employee
                                        .toString(),
                                    nickname: freeGiftController
                                        .theItemFree.variants?[0].nickname
                                        .toString(),
                                    placeInHouse: freeGiftController.theItemFree
                                        .variants?[0].placeInWarehouse
                                        .toString(),
                                    sku: freeGiftController.theItemFree.sku
                                        .toString(),
                                    vendorSku: freeGiftController
                                        .theItemFree.vendorSku
                                        .toString(),
                                    image: freeGiftController
                                        .theItemFree.vendorImagesLinks![0],
                                ...
                                await freeGiftController
                                    .changeRepeatLottie(true);
