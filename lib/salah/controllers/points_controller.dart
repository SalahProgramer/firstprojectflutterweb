...
class PointsController extends ChangeNotifier {
  ...
  ApiPointsController apiPointsController = NavigatorApp.context
      .read<ApiPointsController>();
  ...
  /// Reset all points data (used when deleting account)
  Future<void> resetAllPointsData() async {
    points = "0";
    shekel = 0;
    historyPoints = [];
    phoneProfileController.clear();
    nameProfileController.clear();
    phoneController.clear();
    await clearAllDataPointPage();
    
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('points', '0');
