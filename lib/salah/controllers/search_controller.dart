...
class SearchItemController extends ChangeNotifier {
  ...
  ApiMainProductController apiMainProductController = NavigatorApp.context
      .read<ApiMainProductController>();
  int numPageItemSearch = 1;
  List<Item> subCategories = [];
  List<Item> popUpShoesData = [];
  ApiMainProductController apiMain = NavigatorApp.context
      .read<ApiMainProductController>();
  FavouriteController favouriteController = NavigatorApp.context
      .read<FavouriteController>();

  FetchController fetchController = NavigatorApp.context
      .read<FetchController>();
  ...
  Future<void> getCategories() async {
    if (categoriesSearch.isEmpty) {
      ...
      categoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(basicCategories),
      );
      categoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(secondaryCategories),
      );
      ...
      selectController = SingleSelectController<CategoryModel>(
        categoriesSearch[0],
      );
      ...
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(men.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(women.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(womenPlus.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(allkids.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(girls.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(boys.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(womenAndBaby.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(allShoes.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(kidsShoes.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(menShoes.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(womenShoes.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(underWare.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(home.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(apparel.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(beauty.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(electronics.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(bags.sublist(1)),
      );
      subCategoriesSearch.addAll(
        CategoryModel.fromJsonListCategory(sports.sublist(1)),
      );
      // subCategoriesSearch
      ...
      switch (item.mainCategory) {
        case "Women Apparel":
          if (item.name == "ملابس نسائية") {
            ...
            sizes = womenPlusSizesList.values
                .toList(); // Create a copy of the list
          }
          break;
        ...
        case "Women Apparel, Baby":
          subCategoriesSearch = CategoryModel.fromJsonListCategory(
            womenAndBaby,
          );
          break;
    ...
    if (short.isEmpty) {
      ...
      if (subCategories.isNotEmpty) {
        ...
        for (var item in tempItems) {
          ...
          bool check = await favouriteController.checkFavouriteItem(
            productId: item.id,
          );
