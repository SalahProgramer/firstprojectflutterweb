...
import '../../services/dialogs/checkout/area_city_service/area_city_service.dart';
...
class CheckoutController extends ChangeNotifier {
  ...
  List<City> cities = [];
  List<Area> areas = [];
  final addressItems = NavigatorApp.context
  ...
  Future<void> setCities() async {
    ...
    if (selectedCity != null &&
        !cities.any((city) => city.name == selectedCity!.name)) {
      selectedCity = null;
      selectedArea = null;
      areas = [];
    }
