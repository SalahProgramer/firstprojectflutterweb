...
import 'package:fawri_app_refactor/salah/controllers/APIS/api_rating_controller.dart';
...
class RatingController extends ChangeNotifier {
  ...
  String hasPhone = "";
  String text = "";
  ApiRatingController apiRatingController = NavigatorApp.context
      .read<ApiRatingController>();
