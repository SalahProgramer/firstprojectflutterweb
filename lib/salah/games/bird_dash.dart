...
import 'package:fawri_app_refactor/salah/games/coins.dart';
import 'package:fawri_app_refactor/salah/games/games_cubit.dart';
import 'package:fawri_app_refactor/salah/games/pipe.dart';
...
class BirdDash extends PositionComponent
  ...
  BirdDash()
    : super(
        ...
        priority: 10,
      ); // تحديد أولوية العرض بحيث يظهر الطائر فوق العناصر ذات الأولوية الأقل
  ...
  final Vector2 _gravity = Vector2(
    0,
    1400.0,
  ); // تحديد قوة الجاذبية المؤثرة على الطائر (يدفعه للأسفل)
  final Vector2 _jumpForce = Vector2(
    0,
    -420,
  ); // قوة القفز التي تدفع الطائر للأعلى عند النقر
  ...
  void render(Canvas canvas) {
    ...
    dashSprite.render(
      canvas,
      size: size,
    ); // رسم صورة الطائر داخل `canvas` بحجم العنصر
