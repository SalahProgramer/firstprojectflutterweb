  ...
  Future<void> onLoad() async {
    ...
    parallax = await game.loadParallax(
      [
        ...
        ParallaxImageData(
          'game_images/layer7-bushes.png',
        ), //يتم تحميل عدة صور للخلفية من مجلد game_images، حيث تمثل كل صورة طبقة مختلفة من الخلفية.
      ],
      baseVelocity: Vector2(
        1,
        0,
      ), //يتم تعيين السرعة الأساسية للخلفية بحيث تتحرك نحو اليسار (x = 1، y = 0).
      velocityMultiplierDelta: Vector2(
        1.7,
        0,
      ), //كل طبقة تتحرك بسرعات مختلفة، بحيث تتحرك الطبقات البعيدة أبطأ والطبقات القريبة أسرع، مما يخلق تأثير المنظور (Parallax).
    );
