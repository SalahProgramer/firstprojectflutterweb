...
import 'package:fawri_app_refactor/salah/widgets/widgets_carts/slidable_cart_widget.dart';
...
class WidgetEachCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String number =
        (avaliable.contains("false,")) ? avaliable.split(":").last.trim() : "0";
    ...
    if (cartController.availability.isNotEmpty && index < cartController.availability.length) {
                    ...
                    child: Align(
                        ...
                        child: Text(
                          ...
                          style: CustomTextStyle().rubik.copyWith(
                              color: CustomColor.primaryColor, fontSize: 11.sp),
                        ))),
                Padding(
                    padding: EdgeInsets.symmetric(horizontal: 2.w),
                    child: Align(
                        ...
                        child: Text(
                          ...
                          overflow: TextOverflow.ellipsis,
                          style: CustomTextStyle().rubik.copyWith(
                              color: CustomColor.blueColor, fontSize: 11.sp),
                        )))
              ],
            ),
                    ...
                    children: [
                      ...
                      if (fetchController.showEven != 0)
                        LottieWidget(
                          ...
                          width: (fetchController.showEven == 4) ? 31.w : 30.w,
                          height: (fetchController.showEven == 4) ? 31.w : 30.w,
                        )
                    ],
                  ),
                ),
  ...
  String translateMessageToArabic(String message) {
    ...
    // Common translations
    if (lowerMessage.contains('offer ended') && lowerMessage.contains('price updated')) {
