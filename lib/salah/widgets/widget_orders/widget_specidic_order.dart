...
import 'package:fawri_app_refactor/salah/widgets/widget_orders/specific_description_item_in_order.dart';
import 'package:fawri_app_refactor/salah/widgets/widget_orders/widget_text_grid.dart';
                          ...
                          Padding(
                            ...
                            child: Tooltip(
                              onTriggered: () {
                                Clipboard.setData(
                                  ClipboardData(
                                    text: widget.newestOrder.orderId.toString(),
                                  ),
                                );
                      ...
                      children: [
                        SizedBox(
                          height:
                              ...
                              ? 0.18.sh
                              : (widget.newestOrder.listItemOrder!.isEmpty)
                              ? 0.h
                              : 0.4.sh,
                                    ...
                                    Expanded(
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          printLog(
                                            "oldString${int.tryParse(widget.newestOrder.listItemOrder![index].id)}",
                                          );
                                          printLog(
                                            "newString${(widget.newestOrder).toString()}",
                                          );
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: ButtonDone(
                                        ...
                                        height: 27.h,
                                        haveBouncingWidget: false,
                                        backColor: CustomColor.chrismasColor,
                                          ...
                                          showCancelOrderDialog(
                                            ...
                                            totalDiscountAfterDelete:
                                                orderControllerSalah
                                                    .totalDiscountAfterDelete[widget
                                                    .newestOrder
                                                    .orderId
                                                    .toString()] ??
                                                0,
