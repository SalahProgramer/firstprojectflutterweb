...
class ItemShim extends StatelessWidget {
  ...
  const ItemShim({super.key, required this.hasAnimatedBorder, this.width});
...
class ShimmerItemMoreData extends StatelessWidget {
  const ShimmerItemMoreData({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Expanded(
            child: ShimmerImagePost(borderRadius: BorderRadius.circular(5.r)),
          ),
          SizedBox(height: 5.h),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 4.h, horizontal: 4.w),
