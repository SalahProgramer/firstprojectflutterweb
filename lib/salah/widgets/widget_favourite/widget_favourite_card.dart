    ...
    return InkWell(
      ...
      onTap: () async {
        await pageMainScreenController.changePositionScroll(
          widget.favouriteItem.productId.toString(),
          0,
        );
        await productItemController.clearItemsData();
        await apiProductItemController.resetRequests();
        NavigatorApp.push(ProductItemView(item: item, sizes: ''));
      },
                                ...
                                onPressed: () async {
                                  ...
                                  if (favouriteController
                                    ...
                                    if (check == true) {
                                      ...
                                      String offer = await fetchController
                                          .getOffer();
                                      ...
                                      await cartController.insertData(
                                        ...
                                        shopId: favouriteController.item?.shopId
                                            .toString(),
                                        ...
                                        oldPrice: favouriteController
                                            .item
                                            ?.oldPrice
                                            .toString(),
                                        size: favouriteController
                                            .item
                                            ?.variants?[0]
                                            .size
                                            .toString(),
                                        quantity: 1,
                                        basicQuantity: favouriteController
                                            .item
                                            ?.variants?[0]
                                            .quantity,
                                        totalPrice: totalPrice1(
                                          favouriteController.item!.newPrice
                                              .toString(),
                                          1,
                                        ),
                                        indexVariants: 0,
