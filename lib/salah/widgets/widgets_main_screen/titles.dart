...
class _TitlesState extends State<Titles> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _colorAnimation = ColorTween(
      ...
      end: ((widget.showEven == 1)) ? Colors.white : CustomColor.blueColor,
    ).animate(_controller);
              ...
              child: BouncingWidget(
                child: Text(
                  ...
                  style: CustomTextStyle().heading1L.copyWith(
                    ...
                    color: (fetchController.showEven == 1 && widget.flag == 1)
                        ? Colors.white
                        : Colors.black,
                  ),
                ),
                  ...
                  builder: (context, child) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: _colorAnimation.value, // Animate the line color
                      ),
