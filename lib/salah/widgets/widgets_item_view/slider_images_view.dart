...
class SliderImagesView extends StatefulWidget {
  ...
  @override
  State<SliderImagesView> createState() => SliderImagesViewState();
}

class SliderImagesViewState extends State<SliderImagesView> {
  String get vimeoId {
  ...
  /// Method to pause all video playback
  void pauseVideo() {
    try {
      // Pause MP4 video
      ...
      // Pause Vimeo video by executing JavaScript
      if (webViewController != null && isVimeo) {
      ...
      printLog("Error pausing video: $e");
    }
  }

  /// Method to resume video playback
  void resumeVideo() {
    try {
      // Resume MP4 video
      if (videoPlayerController != null && videoPlayerController!.value.isInitialized) {
      ...
      // Resume Vimeo video by executing JavaScript
      if (webViewController != null && isVimeo) {
        webViewController!.evaluateJavascript(source: '''
          var iframe = document.querySelector('iframe');
          if (iframe) {
      ...
      printLog("Error resuming video: $e");
    }
  }
