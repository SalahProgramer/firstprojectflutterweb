        ...
        bottomNavigationBar: ButtonDone(
          ...
          onPressed: (widget.item.variants?[0].size == "")
              ...
              : (productItemController.inCart[widget.item.id.toString()] ==
                  ...
                  : ((productItemController
                                  .inCart[widget.item.id.toString()]) ==
                              false &&
                          productItemController.update == true)
                      ? () async {
                          Vibration.vibrate(duration: 100);
                          ...
                          await cartController.updateData(
                              id:
                                  "${widget.item.id}00${productItemController.indexItems[widget.item.id.toString()]}",
                              quantity:
                                  productItemController.valueQuantityItems[
                                      widget.item.id.toString()],
                              totalPrice: totalPrice1(
                                  widget.item.newPrice.toString(),
                                  int.parse(productItemController
                                      .valueQuantityItems[
                                          widget.item.id.toString().trim()]
                                      .toString())));
                              ...
                              if ((productItemController
                                ...
                                if (await cartController.checkCartItem(
                                  ...
                                  await cartController.insertData(
                                      id:
                                          "${widget.item.id}00${(productItemController.indexItems[widget.item.id.toString()].toString())}",
                                      productId: widget.item.id,
                                      variantId:widget.item.variants?[productItemController.indexItems[widget.item.id.toString()]?.toInt() ?? 0].id,
                                      shopId: widget.item.shopId.toString(),
                                      employee:
                                          widget.item.variants?[productItemController.indexItems[widget.item.id.toString()]?.toInt() ?? 0].employee
                                                  .toString() ??
                                              "",
                                      nickname:
                                          widget.item.variants?[productItemController.indexItems[widget.item.id.toString()]?.toInt() ?? 0].nickname
                                                  .toString() ??
                                              "",
                                      placeInHouse:
                                          widget.item.variants?[productItemController.indexItems[widget.item.id.toString()]?.toInt() ?? 0].placeInWarehouse
                                              .toString(),
                                      sku: widget.item.sku.toString(),
                                      vendorSku:
                                          widget.item.vendorSku.toString(),
                                      ...
                                      size: (productItemController
                                          ...
                                          .toString()),
                                      quantity:
                                          int.parse(productItemController.valueQuantityItems[widget.item.id.toString().trim()].toString()),
                                      basicQuantity: int.parse(productItemController.basicQuantityItems[widget.item.id.toString().trim()].toString()),
                                      totalPrice: totalPrice1(widget.item.newPrice.toString(), int.parse(productItemController.valueQuantityItems[widget.item.id.toString().trim()].toString())),
                                      indexVariants: productItemController.indexItems[widget.item.id.toString()],
                                  ...
                                  children: [
                                                      ...
                                                      Visibility(
                                                        ...
                                                        child: DotsIndicator(
                                                          ...
                                                          mainAxisAlignment:
                                                              MainAxisAlignment
                                                                  .center,
                                                          position: pageMainScreenController
                                                                      .positionScroll[
                                                                  widget.item.id
                                                                      .toString()] ??
                                                              0,
                                    ...
                                    if (fetchController.showEven != 0)
                                      Positioned(
                                        ...
                                        child: IgnorePointer(
                                            ignoring: true,
                                            child: (fetchController.showEven == 11)
                                                ? Image.asset(
