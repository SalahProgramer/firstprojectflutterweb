...
import 'package:fawri_app_refactor/salah/widgets/styles_product_list/style_three/custom_images_style_three.dart';
import 'package:fawri_app_refactor/salah/widgets/styles_product_list/style_three/item_shimmer_style_three.dart';
...
class WidgetStyleThree extends StatefulWidget {
  final ProductsViewConfigModel config;

  const WidgetStyleThree({super.key, required this.config});

  @override
  State<WidgetStyleThree> createState() => _WidgetStyleThreeState();
}

class _WidgetStyleThreeState extends State<WidgetStyleThree> {
      ...
      child: AnimateSwipeItems(
        ...
        customWidget:
            ...
            ? ListView.builder(
                ...
                itemBuilder: (context, index) => ItemShimmerStyleThree(
                        ...
                        itemBuilder: (context, int index) {
                          {
                            bool favourite = favouriteController
                                .checkFavouriteItemProductId(
                                  productId: widget.config.listItems[index].id!
                                      .toInt(),
                                );
                            ...
                            return AnimationConfiguration.staggeredList(
                              ...
                              child: ScaleAnimation(
                                ...
                                child: FadeInAnimation(
                                  child: CustomImagesStyleThree(
                                    isFavourite: favourite,
                                    hasAnimatedBorder:
                                        widget.config.hasAnimatedBorder,
                                    hasBellChristmas:
                                        widget.config.hasBellChristmas,
                                    isLoadingProduct:
                                        widget.config.isLoadingProduct,
                                    colorsGradient:
                                        widget.config.colorsGradient,
                                    i: widget.config.i,
