...
import 'package:fawri_app_refactor/salah/widgets/styles_product_list/style_four/item_shimmer_style_four.dart';
...
class WidgetStyleFour extends StatefulWidget {
  ...
  const WidgetStyleFour({super.key, required this.config});
                ...
                children: [
                  Expanded(
                    child: Swiper(
                      ...
                      itemHeight: widget
                          .config
                          .effectiveHeight, // ✅ Ensure height is not null
                      itemWidth: widget
                          .config
                          .effectiveWidth, // ✅ Ensure width is not null
