...
class CategoryDesignSpecificWidget extends StatelessWidget {
  ...
  const CategoryDesignSpecificWidget(
      {super.key, required this.categoryModel, required this.isDiscounted});
...
class DesignCategoryWidget extends StatelessWidget {
  ...
  const DesignCategoryWidget(
      {super.key, required this.categoryModel, required this.setBorder});
  ...
  Widget build(BuildContext context) {
    ...
    final smallCategory = (pageMainScreenController.setBigCategories == false &&
                  ...
                  children: [
                    smallCategory
                        ? Container(
                            ...
                            decoration:
                                boxDecoration(isSmallCategory: smallCategory),
                            child: CircleAvatar(
                                radius: 35.r,
                              ...
                              builder: (context) {
                                FirstImagesModel category =
                                  ...
                                  return item.id.toString().trim() ==
                                      categoryModel.id.toString().trim();
                                },
                                            orElse: () => FirstImagesModel(
                                                mainCategory: "",
                                                image: "",
                                                id: "1"));
                                printLog(category.mainCategory);
