        ...
        child: (loadingButton == false)
            ? Text(
                ...
                style: textStyle ??
                    CustomTextStyle()
                        .heading1L
                        .copyWith(color: forColor ?? Colors.white),
              )
            : Row(
  ...
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
            ...
            alignment: Alignment.center,
            shape: RoundedRectangleBorder(
                side: ((noChoiceSize == true) &&
                        (text == "" || text == "اختر مقاسك"))
                ...
                children: [
                  ...
                  Expanded(
                      child: Center(
                          child: Text(text,
                              style:
                                  textStyle ?? CustomTextStyle().heading1L))),
                ],
              ),
            )
          // Text(text, style: textStyle ?? CustomTextStyle().heading1L)
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(subtitle!,
                            style:
                                subTitleStyle ?? CustomTextStyle().heading1L),
                      ],
                    ),
                  ),
                ],
...
class IconSvg extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          shape: BoxShape.circle, color: backColor ?? Colors.black),
      child: (nameIcon != "")
          ? IconButton(
              splashRadius: 100,
              hoverColor: Colors.transparent,
...
class IconSvgPicture extends StatelessWidget {
  ...
  const IconSvgPicture(
      {super.key, required this.nameIcon, this.colorFilter, this.heightIcon});
