import 'package:fawri_app_refactor/salah/models/user/enum_point_status.dart';
import 'package:fawri_app_refactor/salah/models/user/order_check_model.dart';
import 'package:fawri_app_refactor/salah/models/user/pending_order_model.dart';
...
class UserActivity {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'last_enum_status': lastEnumStatus.map(
