class AppSizesData {
  ...
  factory AppSizesData.fromJson(Map<String, dynamic> json) {
    return AppSizesData(
      ...
      women: SizeCategory.fromJson(json['women'] as Map<String, dynamic>? ?? {}),
      womenPlus: SizeCategory.fromJson(json['womenPlus'] as Map<String, dynamic>? ?? {}),
      kidsBoys: SizeCategory.fromJson(json['kidsBoys'] as Map<String, dynamic>? ?? {}),
      kidsGirls: SizeCategory.fromJson(json['kidsGirls'] as Map<String, dynamic>? ?? {}),
      womenShoes: SizeCategory.fromJson(json['womenShoes'] as Map<String, dynamic>? ?? {}),
      menShoes: SizeCategory.fromJson(json['menShoes'] as Map<String, dynamic>? ?? {}),
      kidsShoes: SizeCategory.fromJson(json['kidsShoes'] as Map<String, dynamic>? ?? {}),
      underwear: SizeCategory.fromJson(json['underwear'] as Map<String, dynamic>? ?? {}),
      weddingAndEvents: SizeCategory.fromJson(json['weddingAndEvents'] as Map<String, dynamic>? ?? {}),
    );
  }
