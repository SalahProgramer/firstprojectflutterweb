...
class SizesDataService {
  ...
  Future<void> loadAppSizesData() async {
    try {
      ...
      if (remoteData != null) {
        ...
        appSizesData = AppSizesData.fromJson(constant_sizes_json.appSizesDataJson);
      }
    } catch (e) {
    ...
    try {
      ...
      print('Error loading sizes from local data: $e');
      rethrow;
    }
  }
  ...
  // Men Sizes
  Map<String, String> get menSizesList => 
      appSizesData?.men.sizesList ?? {};
  
  Map<String, bool> get menSizesMap => 
      appSizesData?.men.sizesMap ?? {};

  // Women Sizes
  Map<String, String> get womenSizesList => 
      appSizesData?.women.sizesList ?? {};
  
  Map<String, bool> get womenSizesMap => 
      appSizesData?.women.sizesMap ?? {};
