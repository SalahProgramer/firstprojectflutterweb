...
import 'package:fawri_app_refactor/salah/constants/categories_data_service.dart';
import 'package:fawri_app_refactor/salah/constants/categories_data_model.dart';
...
// Detailed Categories
List<dynamic> get women =>
    toJsonList(CategoriesDataService.instance.women);

List<dynamic> get womenPlus =>
    toJsonList(CategoriesDataService.instance.womenPlus);

List<dynamic> get men =>
    toJsonList(CategoriesDataService.instance.men);

List<dynamic> get boys =>
    toJsonList(CategoriesDataService.instance.boys);

List<dynamic> get girls =>
    toJsonList(CategoriesDataService.instance.girls);

List<dynamic> get allkids =>
    toJsonList(CategoriesDataService.instance.allkids);
...
List<dynamic> get home =>
    toJsonList(CategoriesDataService.instance.home);

List<dynamic> get apparel =>
    toJsonList(CategoriesDataService.instance.apparel);

List<dynamic> get beauty =>
    toJsonList(CategoriesDataService.instance.beauty);

List<dynamic> get electronics =>
    toJsonList(CategoriesDataService.instance.electronics);

List<dynamic> get bags =>
    toJsonList(CategoriesDataService.instance.bags);

List<dynamic> get sports =>
    toJsonList(CategoriesDataService.instance.sports);

List<dynamic> get perfume =>
    toJsonList(CategoriesDataService.instance.perfume);

// Tags
List<dynamic> get tags =>
    tagsToJsonList(CategoriesDataService.instance.tags);
