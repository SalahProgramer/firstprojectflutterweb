      ...
      bottomNavigationBar: ButtonDone(
        ...
        onPressed: () async {
          if (formKey.currentState!.validate()) {
            ...
            double nis = pointsControllerClass.calculateValueInNIS(
              double.parse(
            ...
            await pointsControllerClass.changeAllDiscount(
              nis + pointsControllerClass.discountCoupoun,
            );
            ...
            await pointsControllerClass.changeAllDiscount(
              0 + pointsControllerClass.discountCoupoun,
            );
          }
        },
      ),
                  ...
                  child: CanCustomTextFormField(
                    ...
                    suffixIcon: SizedBox(
                      ...
                      child: ButtonDone(
                        ...
                        iconName: Assets.icons.yes,
                        onPressed:
                            (pointsControllerClass.textPointDo.trim() == "")
                            ? null
                            : () async {
                                FocusScope.of(context).unfocus();
                                ...
                                if (formKey.currentState!.validate()) {
                                  ...
                                  pointsControllerClass.shekelText = nis
                                      .toStringAsFixed(2);
                                  ...
                                  await pointsControllerClass.changeTotal(
                                    pointDouble -
                                        pointsControllerClass.discountCoupoun,
                                  );
                                  await pointsControllerClass
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      numAndText(
                        text: "  شيكل  ",
                        num: pointsControllerClass.shekelText.toString().trim(),
                      ),
                    ],
                  ),
                ),
