...
import '../../../widgets/points_widgets/date_widget.dart';
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        flex: 1,
                        child: Image(
                          image: AssetImage(Assets.images.fawriArabic.path),
                        ),
                      ),
                    ],
                  ),
              ...
              Expanded(
                child: RefreshIndicator(
                  ...
                  child: Container(
                    ...
                    child:
                        (pointsController.historyPoints == null ||
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ListView.separated(
                                    ...
                                    itemCount:
                                        pointsController.historyPoints!.length,
                                    padding: EdgeInsets.only(
                                      bottom: 20.h,
                                      right: 5.w,
                                    ),
                                    itemBuilder: (context, index) {
                                      final currentPoint = pointsController
                                          .historyPoints![index];
                                      ...
                                      if (index > 0) {
                                        ...
                                        previousDate = DateFormat('yyyy-MM-dd')
                                            .format(
                                              DateTime.parse(
                                                prevPoint.date
                                                    .toIso8601String(),
                                      ...
                                      return Column(
                                        ...
                                        children: [
                                          ...
                                          PointTile(
                                            ...
                                            date: MyDateUtil.getFormatedTime(
                                              context: context,
