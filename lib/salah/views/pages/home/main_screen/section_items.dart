...
import 'package:fawri_app_refactor/salah/views/pages/home/main_screen/products_list.dart';
    ...
    return (pageMainScreenController.sections.isNotEmpty &&
        ...
        ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              var bgColor =
                  pageMainScreenController.sections[index].style?.bGColor
                      .toString() ??
                  "";
          ...
          children: [
            ProductsViewInList(
              configModel: ProductsViewConfigModel(
                ...
                numberStyle:
                    (int.tryParse(
                      pageMainScreenController.sections[index].style?.styleId ??
                          "1",
                    )) ??
                    1,
                bgImage: pageMainScreenController.sections[index].bgImage,
                heightBGImage: pageMainScreenController.sections[index].height
                    .toDouble(),
                isLoadingProduct:
              ...
              onTap: () async {
                ...
                NavigatorApp.push(
                  HomeScreen(
                    ...
                    type: pageMainScreenController.sections[index].name
                        .toString(),
                    title: "",
                    url: "",
                    hasAppBar: true,
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      ItemShim(hasAnimatedBorder: false, width: 120.w),
                ),
              ),
            ],
          ),
