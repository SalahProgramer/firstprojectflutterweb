...
import '../../../../../dialog/dialogs/dialog_item_view/dialog_select_sizes_shoes.dart';
import '../../../../controllers/product_item_controller.dart';
import '../../../../models/items/item_model.dart';
import '../../../../widgets/widget_first_open_show.dart';
import '../../../../widgets/widgets_item_view/specefic_product_view.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      analyticsService.logViewContent(
        ...
        price:
            double.tryParse(widget.item.newPrice?.replaceAll("₪", "") ?? "0") ??
            0.0,
        parameters: {
      ...
      timer = Timer(Duration(seconds: 5), () async {
        ...
        if (showPopUpShoes &&
            (pageMainScreenController.userActivity.getEnumStatus('3').canUse ==
                true)) {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        extendBody:
            (productItemController.showTutorial &&
