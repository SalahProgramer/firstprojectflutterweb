...
import 'package:fawri_app_refactor/salah/views/pages/home/main_screen/section_items.dart';
import 'package:fawri_app_refactor/salah/views/pages/home/main_screen/widget_items_viewed.dart';
import '../../../../models/products_view_config.dart';
import 'package:fawri_app_refactor/salah/widgets/widgets_main_screen/button_spin_order.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:provider/provider.dart';
import 'package:rate_my_app/rate_my_app.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../../../../../dialog/dialogs/dialogs_rating/dialog_rating.dart';
...
import '../../../../widgets/widgets_main_screen/show11.dart';
import '../../../../widgets/widgets_main_screen/show_big_small_categories.dart';
import '../../../../widgets/widgets_main_screen/titles.dart';
import '../../../../widgets/widgets_main_screen/home_video_reels_carousel.dart';
...
class _PageMainScreenState extends State<PageMainScreen>
      ...
      child: GestureDetector(
        ...
        child: ClipRRect(
          ...
          child: SizedBox(
            ...
            child: Assets.images.formFawri.image(fit: BoxFit.cover),
          ),
        ),
      ),
    );
  ...
  Future<void> initializeMainScreen() async {
    try {
      ...
      final PointsController pointsControllerClass = context
          .read<PointsController>();
      final RatingController ratingController = context
          .read<RatingController>();
      final OrderControllerSalah orderControllerSalah = context
          .read<OrderControllerSalah>();
  ...
  Future<void> refreshMainData({
    ...
    try {
      // Get HomeCarouselController for refreshing home videos
      final homeCarouselController = NavigatorApp.context.read<HomeCarouselController>();
      ...
      await Future.wait<void>([
        ...
        // Refresh home video reels carousel
        homeCarouselController.refreshVideosForHome().catchError((e) {
          printLog('Error refreshing home videos: ${e.toString()}');
                        ...
                        SliverToBoxAdapter(
                          child: Column(
                            children: [
                              ...
                              ShowBigSmallCategories(isCategory: true),
                              ButtonSpinOrder(),
                              ...
                              //     height: 7.h,
                              //   ),
                              if (fetchController.showFormFawri == true)
                                buildSurveyBanner(),
