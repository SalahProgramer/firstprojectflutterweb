...
class _OrdersPagesState extends State<OrdersPages> {
  ...
  bool isLoadingMore = false; // Prevent multiple simultaneous requests
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      scrollController.addListener(() async {
        ...
        // Check if scrolled near the bottom (80% threshold)
          ...
          if (phone != null && phone.isNotEmpty) {
            ...
            try {
              ...
              if (orderControllerSalah.pageOrder == 0) {
                if (orderControllerSalah.numberOrderNewest >
                    orderControllerSalah.newestOrder.length) {
                  await orderControllerSalah.getNewestOrders(phone, 2);
                }
              } else {
                if (orderControllerSalah.numberOrderOldest >
                    orderControllerSalah.oldestOrder.length) {
            ...
            Container(
              ...
              child: IntrinsicHeight(
                child: Row(
                  ...
                  children: [
                    order(
                      orderControllerSalah.newestOrder,
                      "طلباتك الحالية",
                      0,
                    ...
                    SizedBox(width: 10.w),
                    order(
                      orderControllerSalah.oldestOrder,
                      "طلباتك السابقة",
                      1,
                      orderControllerSalah,
                    ),
  ...
  Widget selected({
    ...
    return ((selectOrder[0].orderId == 0)
        ? (Expanded(
      child: Center(
        child: SpinKitPulse(color: mainColor, size: 40.h),
      ),
    ))
