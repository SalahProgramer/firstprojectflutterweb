...
class _SpinWheelState extends State<SpinWheel> {
  ...
  Widget build(BuildContext context) {
    ...
    final timeRemaining = pageMainScreenController.userActivity
        .getEnumTimeRemaining("2");
    return Container(
      width: 1.sw,
      height: 1.sh,
  ...
  void flingWheel() async {
    ...
    double totalProbability = outcomes.fold(
      0,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                text,
                textDirection: (coupon) ? TextDirection.ltr : TextDirection.rtl,
              ...
              Padding(
                ...
                child: LottieWidget(
                  ...
                  height: (nameIcon == Assets.lottie.pointcoins) ? 50.w : 40.w,
                  name: nameIcon,
                ),
              ),
            ],
