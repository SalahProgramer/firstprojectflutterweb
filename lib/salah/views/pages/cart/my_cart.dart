...
import 'package:fawri_app_refactor/salah/views/pages/cart/button_cart.dart';
...
import 'package:fawri_app_refactor/salah/widgets/empty_widget.dart';
...
import '../../../widgets/widgets_carts/how_to_delete_card.dart';
import '../../../widgets/widgets_carts/widget_each_card.dart';
        ...
        actions: [
          IconSvg(
            ...
            onPressed: () async {
              ...
              NavigatorApp.push(OrdersPages(phone: phone, userId: userId));
            },
                      ...
                      Expanded(
                        child: ScrollablePositionedList.builder(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            if (reversedIndex <
                                cartController.availability.length) {
                              var availabilityData =
                                  cartController.availability[reversedIndex];
                              if (availabilityData.availableQuantity != null &&
                                  availabilityData.availability == "false") {
                                availabilityInfo =
                                    "false, available quantity: ${availabilityData.availableQuantity}";
                              } else {
