          ...
          bottomNavigationBar: BouncingWidget(
            child: ButtonDone(
              ...
              onPressed: () async {
                ...
                if (phoneController.text == "" || nameController.text == "") {
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    Map<int, String> orderSuccess = await addOrder(
                      ...
                      description:
                          (widget.pointControllerText.toString() == "0")
                      ...
                      // hasOrder: "",
                      hasOrder:
                          (orderControllerSalah.checkPendingOrder?.success ==
                              true)
                    ...
                    if ((orderSuccess.containsKey(200) ||
                      ...
                      try {
                        ...
                        await analyticsService.logPurchase(
                          amount:
                              double.tryParse(widget.total.toString()) ?? 0.0,
                          parameters: {
                  ...
                  children: [
                    ...
                    Consumer<AddressProvider>(
                      builder: (context, addressprovider, _) {
                        ...
                        if (currentRegion != "" &&
                            currentRegion != "اختر منطقتك") {
                          List<String> allowedCities = getCityNamesByRegion(
                            currentRegion,
                          );
                          ...
                          addressItems = allAddressItems.where((address) {
                            printLog(
                              "Checking address: ${address.name} - City: ${address.cityName}",
                            );
                            return allowedCities.contains(address.cityName);
                          }).toList();

                          printLog(
                            "Filtered Addresses Count: ${addressItems.length}",
                          );
                        }

                        // Check if the currently selected address is still in the filtered list
                        bool isSelectedAreaValid =
                            selectedArea != null &&
                            addressItems.any(
                        ...
                        return Visibility(
                          ...
                          child: DropdownButtonFormField<AddressItem>(
                            ...
                            items: addressItems
                                .map(
                                  (address) => DropdownMenuItem<AddressItem>(
                                    value: address,
