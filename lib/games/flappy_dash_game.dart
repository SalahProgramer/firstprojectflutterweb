...
import 'flappy_dash_root_component.dart';
import 'games_cubit.dart'; // استيراد الخلفية المتحركة
...
class FlappyDashGame extends FlameGame<FlappyDashWorld>
  ...
  FlappyDashGame(this.gamesCubit)
      : super(
          ...
          camera: CameraComponent.withFixedResolution(
              width: 1.03.sw, height: 1.sh), // ضبط الكاميرا لتناسب أبعاد الشاشة
        );
  ...
  KeyEventResult onKeyEvent(
    ...
    final isSpace = keysPressed.contains(
        LogicalKeyboardKey.space); // التحقق مما إذا كان زر المسافة مضغوطًا
...
class FlappyDashWorld extends World
  ...
  Future<void> onLoad() async {
    ...
    add(FlameBlocProvider<GamesCubit, GamesState>(
        create: () => game.gamesCubit,
        children: [
          rootComponent = FlappyDashRootComponent(),
        ]));
    super.onLoad();
  }
