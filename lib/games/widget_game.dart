import 'package:fawri_app_refactor/games/top_score.dart';
import 'package:fawri_app_refactor/games/widget_game_over.dart';
    ...
    return BlocConsumer<GamesCubit, GamesState>(
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          children: [
            GameWidget(
              game: gameController.flappyDashGame,
            ),
