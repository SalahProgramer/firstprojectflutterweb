...
Future<void> resetNavigationStates(ChecksController checksController) async {
  try {
    await Future.wait<void>([
      checksController.changeNavigateTriggered(nav: false).catchError((
        e,
        stack,
      ) {
...
Future<void> fetchAppDataAfterSkipUpdate(
  ...
  try {
    await Future.wait<void>([
      ...
      Future(() => pageMainScreenController.getItemsViewed()).catchError((
        e,
        stack,
      ) {
        SentryService.captureError(
      ...
      Future(() => pageMainScreenController.fetchRecommendedItems()).catchError(
        (e, stack) {
          SentryService.captureError(
            exception: e,
            stackTrace: stack,
      ...
      Future(() => pageMainScreenController.getAppSections()).catchError((
        e,
        stack,
      ) {
        SentryService.captureError(
