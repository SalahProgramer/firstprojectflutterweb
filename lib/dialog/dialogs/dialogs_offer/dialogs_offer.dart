                            ...
                            actions: [
                              ...
                              CustomButtonWithIconWithoutBackground(
                                ...
                                onPressed: () async {
                                  ...
                                  await cartController.checkProductAvailability(
                                    jsonList,
                                  );
                                  ...
                                  if (cartController
                                    ...
                                    if (int.parse(freeShipValue.toString()) ==
                                      ...
                                      if (double.parse(
                                        ...
                                        await cartController.changeLoading(
                                          false,
                                        );
                                        await pointsController.changeTotal(
                                          double.parse(
                                        ...
                                        await cartController.changeButton(
                                          false,
                                        );
      ...
      Future.delayed(const Duration(milliseconds: 600), () {
        WidgetsBinding.instance.addPostFrameCallback((_) async {
          if (cartController.cartItemsOffers.isNotEmpty) {
            final offerIndex = cartController.cartItems.indexOf(
              cartController.cartItemsOffers.first,
            );
            if (offerIndex >= 0) {
              final reversedIndex =
                        ...
                        children: [
                          ...
                          ButtonDone(
                            ...
                            onPressed: () async {
                              ...
                              printLog(cartController.cartItems[0].toString());
