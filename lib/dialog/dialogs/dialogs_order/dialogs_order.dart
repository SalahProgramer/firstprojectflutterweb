                  ...
                  child: InkWell(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Lottie.asset(Assets.lottie.animation1726476947033,
                              height: 250.h,
                              reverse: true,
                              repeat: true,
                              fit: BoxFit.cover),
              ...
              child: CupertinoAlertDialog(
                ...
                content: Column(
                  children: [
                    ...
                    Text("ارجو منك كتابة سبب إلغاء الطلب ",
                        style: CustomTextStyle()
                            .rubik
                    ...
                    CanCustomTextFormField(
                      ...
                      hintStyle: CustomTextStyle()
                          .heading1L
                          .copyWith(color: Colors.black45, fontSize: 10.sp),
                      maxLines: null,
                ...
                actions: [
                  CustomButtonWithIconWithoutBackground(
                      ...
                      textStyle: CustomTextStyle().rubik.copyWith(
                          color: CustomColor.chrismasColor, fontSize: 12.sp),
                      onPressed: () async {
            ...
            child: Container(
              ...
              child: InkWell(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Lottie.asset(Assets.lottie.animation1701597212878,
                        height: 250.h,
                        reverse: true,
                        repeat: true,
                        fit: BoxFit.cover),
