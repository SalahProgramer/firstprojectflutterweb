...
import '../../../core/widgets/departments_home_widgets/category_specific_widget.dart';
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Padding(
            padding:
                EdgeInsets.only(right: 4.w, top: 5.h, bottom: 5.h, left: 4.w),
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        bool isDiscounted = widget.discountCategories
            .contains(int.parse(sublist[index]["id"].toString()));
