...
class _CheckoutFirstScreenState extends State<CheckoutFirstScreen> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      widget.freeShipValue, pointsController,doClear: true);
    });
    super.initState();
  }
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                            ...
                            onChanged: (String? newValue) async {
                              ...
                              await checkoutController.changeDeliveryPrice(
                                  widget.freeShipValue, pointsController);
                            }),
                      ),
                    ),
                  ),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [
                                Color.fromARGB(255, 71, 1, 236)
                                    .withValues(alpha: 0.1),
                                Color.fromARGB(255, 71, 1, 236)
                                    .withValues(alpha: 0.1),
                                Color.fromARGB(255, 162, 122, 255)
                                    .withValues(alpha: 0.1),
                                Color.fromARGB(255, 91, 178, 250)
                                    .withValues(alpha: 0.1),
                            ...
                            border: Border.all(
                              color: CustomColor.deepPurple.withValues(alpha: 0.8),
                              width: 1.3,
                            ),
                            boxShadow: [
                              BoxShadow(
                                color: CustomColor.deepPurple.withValues(alpha: 0.2),
                                blurRadius: 10,
                                offset: const Offset(0, 4),
                              ),
                            ],
                                  ...
                                  children: [
                                    ...
                                    Visibility(
                                      visible: int.parse(widget.freeShipValue
                                          ...
                                          ? false
                                          : pointsController.total >=
                                              int.parse(widget.freeShipValue
                                                  .toString()),
                                      child: Text(
                              ...
                              if (couponController.text == "noTawseel") {
                                ...
                                if (couponController.text.trim().toString() ==
                                  ...
                                  if (couponExists) {
                                    ...
                                    var res =
                                        await getCoupun(couponController.text);
                                    if (res.toString() == "null" ||
                                      ...
                                      setState(() async {
                                        ...
                                        await pointsController
                                            .changeDiscountCoupon(double.parse(
