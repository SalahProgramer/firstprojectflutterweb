...
import '../../../../core/widgets/widgets_main_screen/ui_specific_item_more_data.dart';
...
class _MoreDataHomeState extends State<MoreDataHome> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      final pageMainScreenController =
        ...
        : SliverGrid.builder(
            ...
            itemBuilder: (context, index) {
              ...
              bool favourite = favouriteController.checkFavouriteItemProductId(
                  productId: pageMainScreenController
                      .itemsMoreData[index].id!
                      .toInt());
              ...
              return InkWell(
                ...
                onTap: () async {
                  await pageMainScreenController.changePositionScroll(
                      pageMainScreenController.itemsMoreData[index].id
                          .toString(),
                      0);
