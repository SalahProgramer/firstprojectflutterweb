...
import '../../../core/widgets/widget_filter/widget_category_filter.dart';
import '../../../core/widgets/widget_filter/widget_price_filter.dart';
import '../../../core/widgets/widget_filter/widget_sizes_filter.dart';
import '../../../core/widgets/widget_filter/widget_sub_category_filter.dart';
import '../../../core/widgets/widget_filter/widget_tags_filter.dart';
            ...
            onPressed: () async {
              await analyticsService.logEvent(
                ...
                parameters: {
                  ...
                  "selected_category":
                      searchItemController.itemCategory.toString(),
                  "selected_sizes":
                      searchItemController.listSelectedSizes.join(','),
              ...
              if (searchItemController.subCategories.isEmpty) {
                ...
                await showItemFilter(
                    scrollController: scrollController, sizes: size);
              }
            }),
        appBar: CustomAppBar(
          title: "فلترة ",
