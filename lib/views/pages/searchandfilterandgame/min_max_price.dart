...
class MinMaxPrice extends StatefulWidget {
  ...
  @override
  State<MinMaxPrice> createState() => _MinMaxPriceState();
}

class _MinMaxPriceState extends State<MinMaxPrice> {
  @override
            ...
            onPressed: (searchItemController.idAndSkuSearch.text == "")
                ...
                : () async {
                    await analyticsService.logEvent(
                      eventName: "min_max_price_confirm",
                      parameters: {
                        "class_name": "MinMaxPrice",
                        "button_name": "تأكيد min max price",
