...
import '../../core/firebase/selected_sizes/selected_sizes_controller.dart';
import '../../core/firebase/selected_sizes/selected_sizes_model.dart';
...
import '../../core/utilities/functions.dart' hide headers;
import '../../core/utilities/global/app_global.dart';
import '../../core/utilities/typedefs/failure.dart';
  ...
  Future<List<Item>> apiCachedProducts(int numPageCachedProducts) async {
    ...
    try {
      Map<String, dynamic> fetchedProducts =
          await apiGetProducts(numPageCachedProducts, 1);
    ...
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        List<SliderModel> category =
            SliderModel.fromJsonList(((res["category"])));
...
// ---get Recommended Products (Recommended)
  ...
  Future<List<Item>> apiBestSellersProducts(int page) async {
    ...
    try {
      var response = await http.get(Uri.parse("$urlTopSELLERS?page=$page"),
          headers: headers);
  ...
  Future<List<SectionModel>> apiAppSections() async {
    ...
    try {
      var response = await http
          .get(Uri.parse("$urlAppSECTIONS?api_key=$keyBath"), headers: headers);
  ...
  Future<List<Item>> apiAllSections(SectionModel element, int page) async {
    ...
    try {
      ...
      var response =
          await http.get(Uri.parse("$url1&page=$page"), headers: headers);
...
// ---get Flash sales (flash Sales)
  Future<FlashModel?> apiFlashItems(int page) async {
    ...
    try {
      var response = await http.get(Uri.parse("$urlFLASHSALES?page=$page"),
          headers: headers);
  ...
  Future<List<Item>> apiViewedItemsData(int page, String ids) async {
    ...
    try {
      ...
      var response = await http.get(Uri.parse("${url}getItemsByIds?ids=$ids"),
          headers: headers);
